...
# add an entry to decision table
...
# add an entry to feature 1 table
...
# add an entry to feature 2 table
...
# add an entry to feature 3 table
...
def main(p4info_file_path, bmv2_file_path):
    ...
    # load p4 runtime and define the switch
    try:
        ...
        # find the entries for decision table
        ...
        # find the entries for feature table 1 2 3
        if len(proto) != 0:
            proto.append(0)
            proto.append(32)
            proto.sort()
